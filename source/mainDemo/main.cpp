...
void demo()
{
    ...
    while (1)
    {
        ...
        if (result != 4231 && welcome_flag == 0 && welcome_counter <= 3)
        {
            ...
            // result = 0; /* DO NOT reset all variables*/
            // digit1 = 0; /* DO NOT reset all variables*/
            // digit2 = 0; /* DO NOT reset all variables*/
            // digit3 = 0; /* DO NOT reset all variables*/
            // digit4 = 0; /* DO NOT reset all variables*/
