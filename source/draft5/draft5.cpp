    ...
    while (1)
    {
        ...
        if (welcome_flag == 1)
        {
            ...
            while (welcome_flag == 1)
            {
                ...
                case 1: //Number 1 has been entered
                    ...
                    LcdMsg("1 entered");
                    digit1 = 1;
                    // insert pressed1.bmp image here
        ...
        if (result == 4231 && welcome_flag == 0)
        {
            ...
            case 1:
                ...
                Sleep(100); // wait for the user to read
                ...
                case 1:
                    ...
                    case 1:
                        ...
                        Sleep(50);
                        // show account balance image here
                        // Sleep(1000);
                        break;
                    case 2:
                ...
                case 3:
                    ...
                    Sleep(2000);
                    // insert account balance image here
                    break;
                default:
        ...
        if (result != 4231 && welcome_flag == 0 && welcome_counter <= 3)
        {
            ...
            {
                // insert image here
                // EcsDrawBMP(1TRY, pScrMgr); /* 1 TRY Image*/
                // Sleep(1000);
            }
            else if (welcome_counter == 1)
            {
                // insert image here
                // EcsDrawBMP(2TRY, pScrMgr); /* 2 TRY Image*/
                // Sleep(1000);
            }
            else if (welcome_counter == 2)
            {
                // insert image here
                // EcsDrawBMP(3TRY, pScrMgr); /* 3 TRY Image*/
                // Sleep(1000);
            }
            LcdClear();
            LcdLine1();
